...
export async function seedDemoData(userId: string, companyId: string) {
  ...
  // === 7. PAGAMENTOS (com valor_parcela e pagamento_itens) ===
  const pag = Array.from({ length: 25 }, () => demoId());
  const pagamentos = [
    // Obra 1 — pagamentos variados
    { id: pag[0], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Terraplanagem fase 1`, tipo_pagamento: 'servico' as const, valor_previsto: 27500, valor_parcela: null, data_vencimento: daysAgo(60), status: 'pago' as const, forma_pagamento: 'pix' as const, fornecedor: 'Terraplanagem Silva', data_compra: daysAgo(65), data_pagamento: daysAgo(60) },
    { id: pag[1], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Concreto usinado - NF 4521`, tipo_pagamento: 'material' as const, valor_previsto: 48000, valor_parcela: null, data_vencimento: daysAgo(45), status: 'pago' as const, forma_pagamento: 'boleto' as const, fornecedor: 'Concreteira ABC', data_compra: daysAgo(50), data_pagamento: daysAgo(45) },
    { id: pag[2], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Aço CA-50 - Parcela 1/3`, tipo_pagamento: 'material' as const, valor_previsto: 38000, valor_parcela: 12666.67, data_vencimento: daysAgo(20), status: 'pago' as const, forma_pagamento: 'boleto' as const, fornecedor: 'Siderúrgica Nacional', numero_parcela: 1, total_parcelas: 3, data_compra: daysAgo(35), data_pagamento: daysAgo(20) },
    { id: pag[3], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Aço CA-50 - Parcela 2/3`, tipo_pagamento: 'material' as const, valor_previsto: 38000, valor_parcela: 12666.67, data_vencimento: daysFromNow(10), status: 'previsto' as const, forma_pagamento: 'boleto' as const, fornecedor: 'Siderúrgica Nacional', numero_parcela: 2, total_parcelas: 3, data_compra: daysAgo(35) },
    { id: pag[4], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Aço CA-50 - Parcela 3/3`, tipo_pagamento: 'material' as const, valor_previsto: 38000, valor_parcela: 12666.66, data_vencimento: daysFromNow(40), status: 'previsto' as const, forma_pagamento: 'boleto' as const, fornecedor: 'Siderúrgica Nacional', numero_parcela: 3, total_parcelas: 3, data_compra: daysAgo(35) },
    { id: pag[5], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Mão de obra - Quinzena 1/Abr`, tipo_pagamento: 'mao_de_obra' as const, valor_previsto: 22000, valor_parcela: null, data_vencimento: daysAgo(5), status: 'atrasado' as const, forma_pagamento: 'transferencia' as const, fornecedor: null, observacoes: 'Aguardando medição aprovada' },
    { id: pag[6], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Impermeabilização - NF 892`, tipo_pagamento: 'material' as const, valor_previsto: 16200, valor_parcela: null, data_vencimento: daysAgo(3), status: 'atrasado' as const, forma_pagamento: 'boleto' as const, fornecedor: 'Impermeabiliza SP', data_compra: daysAgo(10) },
    { id: pag[7], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Mão de obra - Quinzena 2/Abr`, tipo_pagamento: 'mao_de_obra' as const, valor_previsto: 22000, valor_parcela: null, data_vencimento: daysFromNow(5), status: 'previsto' as const, forma_pagamento: 'transferencia' as const, fornecedor: null },
    { id: pag[8], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Madeira para fôrmas 2º pav`, tipo_pagamento: 'material' as const, valor_previsto: 15000, valor_parcela: null, data_vencimento: daysFromNow(10), status: 'previsto' as const, forma_pagamento: 'boleto' as const, fornecedor: 'Madeireira Pinheiro' },
    { id: pag[9], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Concreto lajes 2º pav`, tipo_pagamento: 'material' as const, valor_previsto: 42000, valor_parcela: null, data_vencimento: daysFromNow(25), status: 'previsto' as const, forma_pagamento: 'boleto' as const, fornecedor: 'Concreteira ABC' },
    { id: pag[10], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Aluguel betoneira`, tipo_pagamento: 'aluguel' as const, valor_previsto: 2500, valor_parcela: null, data_vencimento: daysFromNow(2), status: 'previsto' as const, forma_pagamento: 'pix' as const, fornecedor: 'LocaMaq' },
    { id: pag[11], obra_id: obra1Id, descricao: `${DEMO_PREFIX} Engenheiro residente - Abril`, tipo_pagamento: 'servico' as const, valor_previsto: 8500, valor_parcela: null, data_vencimento: daysFromNow(15), status: 'previsto' as const, forma_pagamento: 'transferencia' as const, fornecedor: null },
    // Obra 2 — com parcelamento cartão
    { id: pag[12], obra_id: obra2Id, descricao: `${DEMO_PREFIX} Demolição completa`, tipo_pagamento: 'servico' as const, valor_previsto: 9500, valor_parcela: null, data_vencimento: daysAgo(30), status: 'pago' as const, forma_pagamento: 'pix' as const, fornecedor: 'Demolidora Express', data_compra: daysAgo(35), data_pagamento: daysAgo(30) },
    { id: pag[13], obra_id: obra2Id, descricao: `${DEMO_PREFIX} Reforço estrutural`, tipo_pagamento: 'servico' as const, valor_previsto: 24000, valor_parcela: 8000, data_vencimento: daysAgo(15), status: 'pago' as const, forma_pagamento: 'transferencia' as const, fornecedor: 'Eng. Estrutural Ltda', numero_parcela: 1, total_parcelas: 3, data_compra: daysAgo(20), data_pagamento: daysAgo(15) },
    { id: pag[14], obra_id: obra2Id, descricao: `${DEMO_PREFIX} Reforço estrutural - Parcela 2/3`, tipo_pagamento: 'servico' as const, valor_previsto: 24000, valor_parcela: 8000, data_vencimento: daysFromNow(15), status: 'previsto' as const, forma_pagamento: 'transferencia' as const, fornecedor: 'Eng. Estrutural Ltda', numero_parcela: 2, total_parcelas: 3 },
    { id: pag[15], obra_id: obra2Id, descricao: `${DEMO_PREFIX} Reforço estrutural - Parcela 3/3`, tipo_pagamento: 'servico' as const, valor_previsto: 24000, valor_parcela: 8000, data_vencimento: daysFromNow(45), status: 'previsto' as const, forma_pagamento: 'transferencia' as const, fornecedor: 'Eng. Estrutural Ltda', numero_parcela: 3, total_parcelas: 3 },
    { id: pag[16], obra_id: obra2Id, descricao: `${DEMO_PREFIX} Porcelanato + Argamassa`, tipo_pagamento: 'material' as const, valor_previsto: 28000, valor_parcela: 9333.33, data_vencimento: daysAgo(8), status: 'pago' as const, forma_pagamento: 'cartao' as const, fornecedor: 'Cerâmica Luxo', numero_parcela: 1, total_parcelas: 3, data_compra: daysAgo(12), data_pagamento: daysAgo(8) },
    { id: pag[17], obra_id: obra2Id, descricao: `${DEMO_PREFIX} Porcelanato + Argamassa - Parcela 2/3`, tipo_pagamento: 'material' as const, valor_previsto: 28000, valor_parcela: 9333.33, data_vencimento: daysFromNow(22), status: 'previsto' as const, forma_pagamento: 'cartao' as const, fornecedor: 'Cerâmica Luxo', numero_parcela: 2, total_parcelas: 3 },
    { id: pag[18], obra_id: obra2Id, descricao: `${DEMO_PREFIX} Porcelanato + Argamassa - Parcela 3/3`, tipo_pagamento: 'material' as const, valor_previsto: 28000, valor_parcela: 9333.34, data_vencimento: daysFromNow(52), status: 'previsto' as const, forma_pagamento: 'cartao' as const, fornecedor: 'Cerâmica Luxo', numero_parcela: 3, total_parcelas: 3 },
    { id: pag[19], obra_id: obra2Id, descricao: `${DEMO_PREFIX} Mão de obra assentamento`, tipo_pagamento: 'mao_de_obra' as const, valor_previsto: 8000, valor_parcela: null, data_vencimento: daysAgo(2), status: 'pago' as const, forma_pagamento: 'pix' as const, fornecedor: 'Azulejista Marcos', data_compra: daysAgo(5), data_pagamento: daysAgo(2) },
    { id: pag[20], obra_id: obra2Id, descricao: `${DEMO_PREFIX} Gesseiro - Forro completo`, tipo_pagamento: 'mao_de_obra' as const, valor_previsto: 12000, valor_parcela: null, data_vencimento: daysFromNow(12), status: 'previsto' as const, forma_pagamento: 'pix' as const, fornecedor: 'Gesso & Cia' },
    { id: pag[21], obra_id: obra2Id, descricao: `${DEMO_PREFIX} Tinta e massa corrida`, tipo_pagamento: 'material' as const, valor_previsto: 6500, valor_parcela: null, data_vencimento: daysFromNow(8), status: 'previsto' as const, forma_pagamento: 'dinheiro' as const, fornecedor: 'Tintas Premium' },
    // Obra 3 — projetos
    { id: pag[22], obra_id: obra3Id, descricao: `${DEMO_PREFIX} Projeto arquitetônico`, tipo_pagamento: 'servico' as const, valor_previsto: 35000, valor_parcela: 17500, data_vencimento: daysAgo(10), status: 'pago' as const, forma_pagamento: 'transferencia' as const, fornecedor: 'Arq. & Design', numero_parcela: 1, total_parcelas: 2, data_compra: daysAgo(15), data_pagamento: daysAgo(10) },
    { id: pag[23], obra_id: obra3Id, descricao: `${DEMO_PREFIX} Projeto arquitetônico - Parcela 2/2`, tipo_pagamento: 'servico' as const, valor_previsto: 35000, valor_parcela: 17500, data_vencimento: daysFromNow(20), status: 'previsto' as const, forma_pagamento: 'transferencia' as const, fornecedor: 'Arq. & Design', numero_parcela: 2, total_parcelas: 2 },
    { id: pag[24], obra_id: obra3Id, descricao: `${DEMO_PREFIX} Sondagem SPT`, tipo_pagamento: 'servico' as const, valor_previsto: 12000, valor_parcela: null, data_vencimento: daysAgo(5), status: 'pago' as const, forma_pagamento: 'pix' as const, fornecedor: 'GeoSondagens', data_compra: daysAgo(12), data_pagamento: daysAgo(5) },
  ];
  await checkedInsert('pagamentos', pagamentos);

  // === 7b. PAGAMENTO_ITENS (lançamento de materiais via pagamento) ===
  const pagamentoItens = [
    // Itens do pagamento de concreto (pag[1])
    { pagamento_id: pag[1], obra_id: obra1Id, material_id: null, nome_material_informado: 'Concreto usinado fck 25 MPa', nome_material_normalizado: 'concreto usinado fck 25 mpa', unidade: 'm³', quantidade: 100, preco_unitario: 395, valor_total: 39500, categoria: 'Concreto' },
    { pagamento_id: pag[1], obra_id: obra1Id, material_id: null, nome_material_informado: 'Bomba lança 32m', nome_material_normalizado: 'bomba lanca 32m', unidade: 'diária', quantidade: 3, preco_unitario: 1800, valor_total: 5400, categoria: 'Equipamento' },
    { pagamento_id: pag[1], obra_id: obra1Id, material_id: null, nome_material_informado: 'Taxa de deslocamento', nome_material_normalizado: 'taxa de deslocamento', unidade: 'vb', quantidade: 1, preco_unitario: 3100, valor_total: 3100, categoria: 'Serviço' },
    // Itens do pagamento de aço parcelado (pag[2])
    { pagamento_id: pag[2], obra_id: obra1Id, material_id: mat[1], nome_material_informado: 'Vergalhão CA-50 10mm', nome_material_normalizado: 'vergalhao ca-50 10mm', unidade: 'barra', quantidade: 300, preco_unitario: 42.50, valor_total: 12750, categoria: 'Aço' },
    { pagamento_id: pag[2], obra_id: obra1Id, material_id: mat[6], nome_material_informado: 'Arame recozido', nome_material_normalizado: 'arame recozido', unidade: 'kg', quantidade: 20, preco_unitario: 12.50, valor_total: 250, categoria: 'Aço' },
    { pagamento_id: pag[2], obra_id: obra1Id, material_id: null, nome_material_informado: 'Espaçadores plásticos', nome_material_normalizado: 'espacadores plasticos', unidade: 'un', quantidade: 500, preco_unitario: 0.80, valor_total: 400, categoria: 'Aço' },
    // Itens do pagamento de porcelanato (pag[16])
    { pagamento_id: pag[16], obra_id: obra2Id, material_id: mat[8], nome_material_informado: 'Porcelanato 60x60 cinza', nome_material_normalizado: 'porcelanato 60x60 cinza', unidade: 'm²', quantidade: 220, preco_unitario: 89.90, valor_total: 19778, categoria: 'Acabamento' },
    { pagamento_id: pag[16], obra_id: obra2Id, material_id: mat[11], nome_material_informado: 'Argamassa colante ACIII', nome_material_normalizado: 'argamassa colante aciii', unidade: 'saco', quantidade: 30, preco_unitario: 28, valor_total: 840, categoria: 'Cimento' },
    { pagamento_id: pag[16], obra_id: obra2Id, material_id: mat[12], nome_material_informado: 'Rejunte cinza 5kg', nome_material_normalizado: 'rejunte cinza 5kg', unidade: 'saco', quantidade: 15, preco_unitario: 18, valor_total: 270, categoria: 'Acabamento' },
    // Itens tinta e massa corrida (pag[21])
    { pagamento_id: pag[21], obra_id: obra2Id, material_id: mat[9], nome_material_informado: 'Tinta Acrílica branca 18L', nome_material_normalizado: 'tinta acrilica branca 18l', unidade: 'lata', quantidade: 8, preco_unitario: 320, valor_total: 2560, categoria: 'Pintura' },
    { pagamento_id: pag[21], obra_id: obra2Id, material_id: mat[10], nome_material_informado: 'Massa corrida PVA 25kg', nome_material_normalizado: 'massa corrida pva 25kg', unidade: 'lata', quantidade: 10, preco_unitario: 45, valor_total: 450, categoria: 'Pintura' },
    { pagamento_id: pag[21], obra_id: obra2Id, material_id: null, nome_material_informado: 'Rolo de lã 23cm', nome_material_normalizado: 'rolo de la 23cm', unidade: 'un', quantidade: 12, preco_unitario: 25, valor_total: 300, categoria: 'Ferramentas' },
    { pagamento_id: pag[21], obra_id: obra2Id, material_id: null, nome_material_informado: 'Lixa massa 150', nome_material_normalizado: 'lixa massa 150', unidade: 'un', quantidade: 50, preco_unitario: 3.80, valor_total: 190, categoria: 'Ferramentas' },
  ];
  await checkedInsert('pagamento_itens', pagamentoItens);
  ...
  const precos = [
    { fornecedor_id: forn[0], obra_id: obra1Id, descricao_item_snapshot: 'Concreto fck 25 MPa', preco_unitario: 380, unidade: 'm³', data_referencia: daysAgo(90), origem_preco: 'cotacao' as const, categoria: 'material' },
    { fornecedor_id: forn[0], obra_id: obra1Id, descricao_item_snapshot: 'Concreto fck 25 MPa', preco_unitario: 395, unidade: 'm³', data_referencia: daysAgo(60), origem_preco: 'compra_real' as const, categoria: 'material', observacoes: 'Reajuste de 4% - inflação de cimento' },
    { fornecedor_id: forn[0], obra_id: obra1Id, descricao_item_snapshot: 'Concreto fck 25 MPa', preco_unitario: 410, unidade: 'm³', data_referencia: daysAgo(15), origem_preco: 'compra_real' as const, categoria: 'material', observacoes: 'Novo reajuste' },
    { fornecedor_id: forn[0], obra_id: obra1Id, descricao_item_snapshot: 'Concreto fck 30 MPa', preco_unitario: 440, unidade: 'm³', data_referencia: daysAgo(60), origem_preco: 'cotacao' as const, categoria: 'material' },
    { fornecedor_id: forn[0], obra_id: obra1Id, descricao_item_snapshot: 'Bomba lança 32m', preco_unitario: 1800, unidade: 'diária', data_referencia: daysAgo(15), origem_preco: 'compra_real' as const, categoria: 'equipamento' },
    { fornecedor_id: forn[1], obra_id: obra1Id, descricao_item_snapshot: 'Vergalhão CA-50 10mm', preco_unitario: 39.90, unidade: 'barra 12m', data_referencia: daysAgo(90), origem_preco: 'cotacao' as const, categoria: 'material' },
    { fornecedor_id: forn[1], obra_id: obra1Id, descricao_item_snapshot: 'Vergalhão CA-50 10mm', preco_unitario: 42.50, unidade: 'barra 12m', data_referencia: daysAgo(35), origem_preco: 'compra_real' as const, categoria: 'material' },
    { fornecedor_id: forn[1], obra_id: obra1Id, descricao_item_snapshot: 'Vergalhão CA-50 8mm', preco_unitario: 28.00, unidade: 'barra 12m', data_referencia: daysAgo(35), origem_preco: 'compra_real' as const, categoria: 'material' },
    { fornecedor_id: forn[1], obra_id: obra1Id, descricao_item_snapshot: 'Arame recozido', preco_unitario: 12.50, unidade: 'kg', data_referencia: daysAgo(35), origem_preco: 'compra_real' as const, categoria: 'material' },
    { fornecedor_id: forn[3], obra_id: obra1Id, descricao_item_snapshot: 'Tábua pinus 30cm', preco_unitario: 35, unidade: 'm', data_referencia: daysAgo(40), origem_preco: 'compra_real' as const, categoria: 'material' },
    { fornecedor_id: forn[3], obra_id: obra1Id, descricao_item_snapshot: 'Compensado plastificado 18mm', preco_unitario: 180, unidade: 'chapa', data_referencia: daysAgo(40), origem_preco: 'cotacao' as const, categoria: 'material' },
    { fornecedor_id: forn[2], obra_id: obra1Id, descricao_item_snapshot: 'Terraplenagem - corte e aterro', preco_unitario: 32, unidade: 'm³', data_referencia: daysAgo(85), origem_preco: 'compra_real' as const, categoria: 'servico' },
    { fornecedor_id: forn[4], obra_id: obra1Id, descricao_item_snapshot: 'Impermeabilização manta asfáltica', preco_unitario: 75, unidade: 'm²', data_referencia: daysAgo(50), origem_preco: 'compra_real' as const, categoria: 'servico' },
    { fornecedor_id: forn[5], obra_id: obra2Id, descricao_item_snapshot: 'Porcelanato 60x60 cinza', preco_unitario: 89.90, unidade: 'm²', data_referencia: daysAgo(20), origem_preco: 'compra_real' as const, categoria: 'material' },
    { fornecedor_id: forn[5], obra_id: obra2Id, descricao_item_snapshot: 'Porcelanato 60x60 branco', preco_unitario: 95.00, unidade: 'm²', data_referencia: daysAgo(20), origem_preco: 'cotacao' as const, categoria: 'material' },
    { fornecedor_id: forn[5], obra_id: obra2Id, descricao_item_snapshot: 'Cerâmica parede banheiro', preco_unitario: 65.00, unidade: 'm²', data_referencia: daysAgo(20), origem_preco: 'cotacao' as const, categoria: 'material' },
    { fornecedor_id: forn[6], obra_id: obra2Id, descricao_item_snapshot: 'Forro de gesso - instalação', preco_unitario: 80, unidade: 'm²', data_referencia: daysAgo(5), origem_preco: 'cotacao' as const, categoria: 'mao_de_obra' },
    { fornecedor_id: forn[7], obra_id: obra2Id, descricao_item_snapshot: 'Tinta acrílica premium 18L', preco_unitario: 320, unidade: 'lata', data_referencia: daysAgo(5), origem_preco: 'cotacao' as const, categoria: 'material' },
    { fornecedor_id: forn[7], obra_id: obra2Id, descricao_item_snapshot: 'Massa corrida PVA 25kg', preco_unitario: 45, unidade: 'lata', data_referencia: daysAgo(5), origem_preco: 'cotacao' as const, categoria: 'material' },
    { fornecedor_id: forn[6], obra_id: obra2Id, descricao_item_snapshot: 'Mão de obra assentamento piso', preco_unitario: 40, unidade: 'm²', data_referencia: daysAgo(10), origem_preco: 'compra_real' as const, categoria: 'mao_de_obra' },
    { fornecedor_id: forn[8], obra_id: obra3Id, descricao_item_snapshot: 'Sondagem SPT por furo', preco_unitario: 2000, unidade: 'furo', data_referencia: daysAgo(15), origem_preco: 'compra_real' as const, categoria: 'servico' },
    { fornecedor_id: forn[9], obra_id: obra3Id, descricao_item_snapshot: 'Projeto estrutural galpão', preco_unitario: 28000, unidade: 'vb', data_referencia: daysAgo(10), origem_preco: 'cotacao' as const, categoria: 'servico' },
    { fornecedor_id: forn[2], obra_id: obra3Id, descricao_item_snapshot: 'Aluguel retroescavadeira', preco_unitario: 450, unidade: 'hora', data_referencia: daysAgo(5), origem_preco: 'cotacao' as const, categoria: 'equipamento' },
  ];

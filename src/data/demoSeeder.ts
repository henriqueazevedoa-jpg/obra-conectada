...
export async function seedDemoData(userId: string, companyId: string) {
  ...
  const diarios = [
    ...
    // Obra 3 - 2 registros (planejamento)
  ...
  const pagamentos = [
    ...
    // Obra 2 - 8 pagamentos (incluindo parcelas)
    ...
    // Obra 3 - 5 pagamentos (projetos/planejamento)
  ...
  const pendencias = [
    ...
    // Obra 3 - 5 pendências (planejamento)
  ...
  const precos = [
    // Concreteira ABC - múltiplos itens e datas

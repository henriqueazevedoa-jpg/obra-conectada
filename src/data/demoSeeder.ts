...
// ══════════════════════ 8. FORNECEDORES / PREÇOS / AGENDA / DOCUMENTOS ══════════════════════
  ...
  const fornecedores = [
    // Obra 1
    {
      id: 'f8c4c8b8-bb0a-4b97-a204-f3f779890fb2',
      obra_id: obra1Id,
      company_id: companyId,
    ...
    {
      id: '1cfbf113-6fd1-44fd-825f-8ba95a4f7ef8',
      obra_id: obra1Id,
      company_id: companyId,
    ...
    {
      id: '748b379e-eb06-4767-8afa-7ccb6cf72aa8',
      obra_id: obra1Id,
      company_id: companyId,
    ...
    // Obra 2
    {
      id: '569f3632-df2c-4fb0-bd30-569b234a8707',
      obra_id: obra2Id,
      company_id: companyId,
      nome: 'DepMat Barueri',
    ...
    {
      id: '9ad572db-657b-46fd-97bf-400ad19c1188',
      obra_id: obra2Id,
      company_id: companyId,
    ...
    {
      id: 'd0195f45-074a-4541-b2ad-ed840571959d',
      obra_id: obra2Id,
      company_id: companyId,
    ...
    {
      id: '793f2c26-ebed-4635-b825-622e02e919d1',
      obra_id: obra2Id,
      company_id: companyId,
      nome: 'Engemix',
      contato: 'Fabio Lima',
    ...
    // Obra 3
    {
      id: '0e9dee20-dbfe-407a-9819-27875b64a59a',
      obra_id: obra3Id,
      company_id: companyId,
      nome: 'MoviTerra Ltda',
    ...
    {
      id: '76d8ed97-1a78-4272-b172-3b740dd9b045',
      obra_id: obra3Id,
      company_id: companyId,
      nome: 'Estacas Brasil',
    ...
    {
      id: '1778793f-d142-4085-909a-78134cfae216',
      obra_id: obra3Id,
      company_id: companyId,
      nome: 'SteelBuild',
    ...
    {
      id: 'a64d0dcf-e42d-4b6d-9df2-c545cb5c197c',
      obra_id: obra3Id,
      company_id: companyId,
      nome: 'HeavyLift',
    ...
    // Obra 4
    {
      id: '14029411-188f-4a66-a196-06047a1437c1',
      obra_id: obra4Id,
      company_id: companyId,
    ...
    {
      id: '87764208-2ab5-4bd4-948e-a5bbbe8a630c',
      obra_id: obra4Id,
      company_id: companyId,
    ...
    {
      id: '105a9b9d-4672-40ed-beb2-a606541e66b7',
      obra_id: obra4Id,
      company_id: companyId,
      nome: 'Verde Jardins',
    ...
    {
      id: 'ad1e85ab-97f5-42b3-98fd-bf760f517616',
      obra_id: obra4Id,
      company_id: companyId,
      nome: 'Clean Obras',
      contato: 'Sergio Mota',
  ...
  const precosFornecedores = [
    ...
    {
      id: demoId(),
      fornecedor_id: 'f8c4c8b8-bb0a-4b97-a204-f3f779890fb2',
      obra_id: obra1Id,
      descricao_item_snapshot: 'Porcelanato premium 80x80',
      categoria: 'acabamentos',
      unidade: 'm²',
      preco_unitario: 185,
    ...
    {
      id: demoId(),
      fornecedor_id: '1cfbf113-6fd1-44fd-825f-8ba95a4f7ef8',
      obra_id: obra1Id,
      descricao_item_snapshot: 'Mármore Carrara',
      categoria: 'marmores',
      unidade: 'm²',
      preco_unitario: 420,
    ...
    {
      id: demoId(),
      fornecedor_id: '748b379e-eb06-4767-8afa-7ccb6cf72aa8',
      obra_id: obra1Id,
      descricao_item_snapshot: 'Marcenaria sob medida',
      categoria: 'marcenaria',
      unidade: 'vb',
      preco_unitario: 38000,
    ...
    {
      id: demoId(),
      fornecedor_id: '569f3632-df2c-4fb0-bd30-569b234a8707',
      obra_id: obra2Id,
      descricao_item_snapshot: 'Cimento CP-II 50kg',
      categoria: 'materiais',
      unidade: 'saco',
      preco_unitario: 39,
    ...
    {
      id: demoId(),
      fornecedor_id: '9ad572db-657b-46fd-97bf-400ad19c1188',
      obra_id: obra2Id,
      descricao_item_snapshot: 'Bloco cerâmico 14x19x39',
      categoria: 'alvenaria',
      unidade: 'un',
      preco_unitario: 1.9,
    ...
    {
      id: demoId(),
      fornecedor_id: 'd0195f45-074a-4541-b2ad-ed840571959d',
      obra_id: obra2Id,
      descricao_item_snapshot: 'Vergalhão CA-50 10mm',
      categoria: 'aco',
      unidade: 'barra',
      preco_unitario: 78,
    ...
    {
      id: demoId(),
      fornecedor_id: '793f2c26-ebed-4635-b825-622e02e919d1',
      obra_id: obra2Id,
      descricao_item_snapshot: 'Concreto fck 25',
      categoria: 'concreto',
      unidade: 'm³',
      preco_unitario: 470,
    ...
    {
      id: demoId(),
      fornecedor_id: '0e9dee20-dbfe-407a-9819-27875b64a59a',
      obra_id: obra3Id,
      descricao_item_snapshot: 'Terraplenagem mecanizada',
      categoria: 'terraplenagem',
      unidade: 'vb',
      preco_unitario: 86000,
      data_referencia: daysAgo(20),
      origem_preco: 'compra_real',
    },
    {
      id: demoId(),
      fornecedor_id: '76d8ed97-1a78-4272-b172-3b740dd9b045',
      obra_id: obra3Id,
      descricao_item_snapshot: 'Estaca hélice contínua',
      categoria: 'fundacao',
      unidade: 'm',
      preco_unitario: 252.1,
      data_referencia: daysAgo(5),
      origem_preco: 'cotacao',
    },
    {
      id: demoId(),
      fornecedor_id: '1778793f-d142-4085-909a-78134cfae216',
      obra_id: obra3Id,
      descricao_item_snapshot: 'Estrutura metálica',
      categoria: 'estrutura_metalica',
      unidade: 'vb',
      preco_unitario: 280000,
      data_referencia: daysAgo(3),
      origem_preco: 'cotacao',
    },
    {
      id: demoId(),
      fornecedor_id: 'a64d0dcf-e42d-4b6d-9df2-c545cb5c197c',
      obra_id: obra3Id,
      descricao_item_snapshot: 'Locação de guindaste',
      categoria: 'equipamentos',
      unidade: 'diária',
      preco_unitario: 6000,
      data_referencia: daysAgo(2),
    ...
    {
      id: demoId(),
      fornecedor_id: '14029411-188f-4a66-a196-06047a1437c1',
      obra_id: obra4Id,
      descricao_item_snapshot: 'Porcelanato litoral premium',
      categoria: 'acabamentos',
      unidade: 'm²',
      preco_unitario: 198,
      data_referencia: daysAgo(20),
    ...
    {
      id: demoId(),
      fornecedor_id: '87764208-2ab5-4bd4-948e-a5bbbe8a630c',
      obra_id: obra4Id,
      descricao_item_snapshot: 'Equipamentos da piscina',
      categoria: 'piscina',
      unidade: 'vb',
      preco_unitario: 18500,
      data_referencia: daysAgo(16),
      origem_preco: 'compra_real',
    },
    {
      id: demoId(),
      fornecedor_id: '105a9b9d-4672-40ed-beb2-a606541e66b7',
      obra_id: obra4Id,
      descricao_item_snapshot: 'Paisagismo final',
      categoria: 'paisagismo',
      unidade: 'vb',
